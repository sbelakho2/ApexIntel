...
VALUES
    ...
    ('22222222-2222-2222-2222-222222222210', 'Technology Obsolescence', 'Legacy system end-of-life', 'operational', 'low', 0.45, 0.85, 'NA', NULL, 'resolved');
...
-- The activity_feed trigger references updated_at which doesn't exist in this table
-- Drop it before inserting test data
...
VALUES
    ...
    ('77777777-7777-7777-7777-777777777702', 'team-ops', 'Operations Team', 'investigation', '33333333-3333-3333-3333-333333333301', 'admin-1', 'analyst-2', 'contributor'),
    ...
    ('77777777-7777-7777-7777-777777777704', 'team-mna', 'M&A Team', 'investigation', '33333333-3333-3333-3333-333333333305', 'admin-2', 'analyst-2', 'lead'),
...
BEGIN
    ...
    IF v_count > 0 THEN
        validation_result := 'FAIL: Found ' || v_count || ' items with invalid priority (must be 1-100)';
        RETURN NEXT;
    ELSE
        validation_result := 'PASS: All priority values are valid (1-100)';
        RETURN NEXT;
    END IF;
    ...
    IF v_count > 0 THEN
        validation_result := 'FAIL: Found ' || v_count || ' items with invalid status';
        RETURN NEXT;
    ELSE
        validation_result := 'PASS: All status values are valid';
        RETURN NEXT;
    END IF;
    ...
    IF v_count > 0 THEN
        validation_result := 'WARN: Found ' || v_count || ' duplicate queue items';
        RETURN NEXT;
    ELSE
        validation_result := 'PASS: No duplicate queue items found';
        RETURN NEXT;
    END IF;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    ...
    IF v_count > 0 THEN
        validation_result := 'FAIL: Found ' || v_count || ' opportunities with invalid priority_score';
        RETURN NEXT;
    ELSE
        validation_result := 'PASS: All priority_score values are valid (0-1)';
        RETURN NEXT;
    END IF;
    ...
    IF v_count > 0 THEN
        validation_result := 'FAIL: Found ' || v_count || ' opportunities with invalid confidence';
        RETURN NEXT;
    ELSE
        validation_result := 'PASS: All confidence values are valid (0-1)';
        RETURN NEXT;
    END IF;
    ...
    IF v_count > 0 THEN
        validation_result := 'WARN: Found ' || v_count || ' active opportunities past their due date';
        RETURN NEXT;
    ELSE
        validation_result := 'PASS: No overdue active opportunities';
        RETURN NEXT;
    END IF;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    ...
    IF v_count > 0 THEN
        validation_result := 'FAIL: Found ' || v_count || ' threats with invalid impact_score';
        RETURN NEXT;
    ELSE
        validation_result := 'PASS: All impact_score values are valid (0-1)';
        RETURN NEXT;
    END IF;
    ...
    IF v_count > 0 THEN
        validation_result := 'FAIL: Found ' || v_count || ' threats with invalid severity';
        RETURN NEXT;
    ELSE
        validation_result := 'PASS: All severity values are valid';
        RETURN NEXT;
    END IF;
    ...
    IF v_count > 0 THEN
        validation_result := 'FAIL: Found ' || v_count || ' critical/high threats past SLA deadline';
        RETURN NEXT;
    ELSE
        validation_result := 'PASS: No critical/high threats past SLA deadline';
        RETURN NEXT;
    END IF;
    ...
    IF v_count > 0 THEN
        validation_result := 'WARN: Found ' || v_count || ' active threats with expired SLA (>7 days)';
        RETURN NEXT;
    ELSE
        validation_result := 'PASS: No active threats with expired SLA';
        RETURN NEXT;
    END IF;
END;
$$ LANGUAGE plpgsql;
