...
pub fn ems_keywords(lang: &str) -> Vec<&'static str> {
    match lang {
        "fr" => vec![
            "sous-traitance électronique", "CMS", "assemblage", "circuits imprimés",
            "fabrication électronique", "câblage",
        ],
        "ar" => vec![
            "تصنيع إلكتروني", "تجميع", "لوحات الدوائر المطبوعة",
            "تعهيد التصنيع", "تركيب المكونات السطحية",
        ],
        "zh" => vec![
            "电子制造服务", "SMT贴片", "PCB组装", "合同制造",
            "电子组装", "代工生产",
        ],
        "ja" => vec![
            "電子製造サービス", "SMT実装", "基板組立", "受託製造",
        ],
        "ko" => vec![
            "전자제조서비스", "SMT실장", "PCB조립", "위탁제조",
        ],
        _ => vec![
            "EMS", "contract manufacturing", "SMT", "THT", "PCB assembly",
            "box build", "cable harness", "AOI", "ICT", "BGA", "conformal coating",
        ],
    }
}
...
mod tests {
    ...
    fn test_detect_english() {
        let text = "The company specializes in electronic manufacturing services for automotive industry.";
