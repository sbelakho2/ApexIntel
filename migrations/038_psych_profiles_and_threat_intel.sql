...
BEGIN
    IF EXISTS (SELECT 1 FROM information_schema.columns
               WHERE table_name = 'sentiment_time_series' AND column_name = 'time_bucket') THEN
        EXECUTE 'CREATE INDEX IF NOT EXISTS idx_sentiment_entity ON sentiment_time_series(entity_id, entity_type)';
        EXECUTE 'CREATE INDEX IF NOT EXISTS idx_sentiment_bucket ON sentiment_time_series(time_bucket DESC)';
    END IF;
END $$;
